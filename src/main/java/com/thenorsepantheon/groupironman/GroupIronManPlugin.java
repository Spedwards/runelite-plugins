...
public class GroupIronManPlugin extends Plugin
{
	...
	public void onMenuOptionClicked(MenuOptionClicked event)
	{
		...
		if (entryMatches(event, "Trade with") && !players.contains(cleanName(event.getMenuTarget())))
		{
		...
		if (entryMatches(event, "Challenge") && !players.contains(cleanName(event.getMenuTarget())))
		{
			event.consume();
